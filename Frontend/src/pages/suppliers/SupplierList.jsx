...
function SupplierList() {
    ...
    const fetchSuppliers = async () => {
        try {
            ...
            toast.error(getErrorMessage(error, "Unable to load suppliers."));
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleDelete = async (id) => {
        ...
        try {
            ...
            toast.error(getErrorMessage(error, "Unable to delete supplier."));
        }
    };
    ...
    return (
        <DashboardLayout>
            <div className="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h3>Suppliers</h3>
                    <small>Manage Fabric, Yarn, and Material Vendors</small>
                </div>
                <button
            ...
            <input
                ...
                placeholder="Search Supplier by name, contact, phone, city..."
                value={search}
                onChange={(e) => {
